...
begin
  ...
  begin
    ShowMessage('Diretório não encontrado: ' + DirectoryPath);
    Screen.Cursor := crDefault;
    lblstatusNfe.Caption := 'Diretório não encontrado';
  ...
  begin
    ...
    lblstatusNfe.Caption := 'Aguardando a Seleção da Data';
    lblstatusNfe.Font.Color := clBlack;
    Exit;
  end;
  ...
  try
    ...
    ZipFile.OnProgress := EventoOnProgress;
    try
      ZipFile.Open('C:\Email\ArquivosCompactadosNfe.zip', zmWrite); // Onde eles vão
